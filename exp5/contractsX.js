// Like contracts.js, but with WeakMap replaces by WeakMapX
...
(function() {
  ...
  */
  ...
  WeakMapX = (function() {
      function WeakMapX () {
          WeakMapX.prototype.set = function(v, o) { v.ORIG = o; };
          WeakMapX.prototype.get = function(v) { return v.ORIG; };
      }
      return WeakMapX;
  })();

  contract_orig_map = new WeakMapX();

  Unproxy = (function() {

    function Unproxy() {
      if (typeof WeakMapX !== "undefined" && WeakMapX !== null) {
        this.hasWeak = true;
        this.unproxy = new WeakMapX();
      } else {
        this.hasWeak = false;
        this.unproxy = [];
      }
